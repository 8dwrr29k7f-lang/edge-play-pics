    ...
    .setDescription(
      [
        ...
        s.usedSeed
          ...
          : "_Priors update as you `/grade` results. Patterns guide process — never force tickets._",
        "",
        "**Process rules**",
        "• LOCK only when model + edge + data quality + autopsy all pass",
...
export function enhanceReviewEmbed() {
  ...
  return new EmbedBuilder()
    ...
    .setFooter({ text: "Patterns guide process — they don’t force tickets · 21+" })
    .setTimestamp();
}
